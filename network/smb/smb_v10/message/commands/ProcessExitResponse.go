...
// ProcessExitResponse
// Source: https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-cifs/343fc704-52db-48a5-b999-439e134c1c9d
...
//
// Returns:
// - A pointer to the new ProcessExitResponse structure
func NewProcessExitResponse() *ProcessExitResponse {
	c := &ProcessExitResponse{
		// Parameters
	...
	c.Command.SetCommandCode(codes.SMB_COM_PROCESS_EXIT)
...
//
// Returns:
// - A byte array representing the ProcessExitResponse structure
...
func (c *ProcessExitResponse) Marshal() ([]byte, error) {
	...
	// Marshalling parameter ByteCount
	buf2 = make([]byte, 2)
	binary.BigEndian.PutUint16(buf2, uint16(c.ByteCount))
...
func (c *ProcessExitResponse) Unmarshal(data []byte) (int, error) {
	...
	// Unmarshalling parameter ByteCount
	if len(rawParametersContent) < offset+2 {
	    return offset, fmt.Errorf("rawParametersContent too short for ByteCount")
	}
	c.ByteCount = types.USHORT(binary.BigEndian.Uint16(rawParametersContent[offset:offset+2]))
	offset += 2
