...
// ProcessExitRequest
// Source: https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-cifs/bb004a18-34b6-47f3-a1d1-f1dfe441a222
...
//
// Returns:
// - A pointer to the new ProcessExitRequest structure
func NewProcessExitRequest() *ProcessExitRequest {
	c := &ProcessExitRequest{
		// Parameters
...
//
// Returns:
// - A byte array representing the ProcessExitRequest structure
