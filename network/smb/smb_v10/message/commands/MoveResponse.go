...
// MoveResponse is the response for SMB_COM_MOVE (0x2A).
//
...
// NewMoveResponse creates a new MoveResponse structure
//
// Returns:
// - A pointer to the new MoveResponse structure
...
// Marshal marshals the MoveResponse structure into a byte array
//
// Returns:
// - A byte array representing the MoveResponse structure
// - An error if the marshaling fails
func (c *MoveResponse) Marshal() ([]byte, error) {
...
func (c *MoveResponse) Unmarshal(rawData []byte) (int, error) {
