...
// FindClose2Request
// Source: https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-cifs/a0ac55c1-d2ed-4c38-b2f6-6d4af4490d87
...
//
// Returns:
// - A pointer to the new FindClose2Request structure
func NewFindClose2Request() *FindClose2Request {
	c := &FindClose2Request{
		// Parameters
		SearchHandle: types.USHORT(0),
	}

	c.Command.SetCommandCode(codes.SMB_COM_FIND_CLOSE2)
...
//
// Returns:
// - A byte array representing the FindClose2Request structure
...
func (c *FindClose2Request) Unmarshal(data []byte) (int, error) {
	...
	// Unmarshalling parameter SearchHandle
