...
// NtCancelRequest
// Source: https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-cifs/e4f9bcfa-982e-43dd-8db7-92db9aac13cc
...
//
// Returns:
// - A pointer to the new NtCancelRequest structure
func NewNtCancelRequest() *NtCancelRequest {
	c := &NtCancelRequest{}

	c.Command.SetCommandCode(codes.SMB_COM_NT_CANCEL)
...
//
// Returns:
// - A byte array representing the NtCancelRequest structure
