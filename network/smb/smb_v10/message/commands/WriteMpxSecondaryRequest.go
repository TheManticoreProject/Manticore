...
// WriteMpxSecondaryRequest is the request for SMB_COM_WRITE_MPX_SECONDARY (0x1F).
//
...
type WriteMpxSecondaryRequest struct {
	command_interface.Command
}

// NewWriteMpxSecondaryRequest creates a new WriteMpxSecondaryRequest structure
//
// Returns:
// - A pointer to the new WriteMpxSecondaryRequest structure
func NewWriteMpxSecondaryRequest() *WriteMpxSecondaryRequest {
	c := &WriteMpxSecondaryRequest{}
...
// Marshal marshals the WriteMpxSecondaryRequest structure into a byte array
//
// Returns:
// - A byte array representing the WriteMpxSecondaryRequest structure
// - An error if the marshaling fails
func (c *WriteMpxSecondaryRequest) Marshal() ([]byte, error) {
...
func (c *WriteMpxSecondaryRequest) Unmarshal(rawData []byte) (int, error) {
