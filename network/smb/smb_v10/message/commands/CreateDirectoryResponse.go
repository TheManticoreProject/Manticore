...
// Source: https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-cifs/90dee346-9411-4e97-9022-4d2caf02562e
...
//
// Returns:
// - A pointer to the new CreateDirectoryResponse structure
func NewCreateDirectoryResponse() *CreateDirectoryResponse {
	c := &CreateDirectoryResponse{
		// Parameters
	...
	c.Command.SetCommandCode(codes.SMB_COM_CREATE_DIRECTORY)
...
//
// Returns:
// - A byte array representing the CreateDirectoryResponse structure
