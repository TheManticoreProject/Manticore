...
// LockingAndxResponse
// Source: https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-cifs/165cd91f-1207-419e-bb62-eb305ea9a67a
...
//
// Returns:
// - A byte array representing the LockingAndxResponse structure
...
func (c *LockingAndxResponse) Marshal() ([]byte, error) {
	...
	rawParametersContent = append(rawParametersContent, types.UCHAR(c.AndXOffset))
...
func (c *LockingAndxResponse) Unmarshal(data []byte) (int, error) {
	...
	if len(rawParametersContent) < offset+1 {
	    return offset, fmt.Errorf("data too short for AndXOffset")
	}
	c.AndXOffset = types.UCHAR(rawParametersContent[offset])
	offset++
