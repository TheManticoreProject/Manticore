...
// CloseAndTreeDiscRequest is the request for SMB_COM_CLOSE_AND_TREE_DISC (0x31).
//
...
type CloseAndTreeDiscRequest struct {
	command_interface.Command
}

// NewCloseAndTreeDiscRequest creates a new CloseAndTreeDiscRequest structure
//
// Returns:
// - A pointer to the new CloseAndTreeDiscRequest structure
func NewCloseAndTreeDiscRequest() *CloseAndTreeDiscRequest {
	c := &CloseAndTreeDiscRequest{}
...
// Marshal marshals the CloseAndTreeDiscRequest structure into a byte array
//
// Returns:
// - A byte array representing the CloseAndTreeDiscRequest structure
// - An error if the marshaling fails
func (c *CloseAndTreeDiscRequest) Marshal() ([]byte, error) {
...
func (c *CloseAndTreeDiscRequest) Unmarshal(rawData []byte) (int, error) {
