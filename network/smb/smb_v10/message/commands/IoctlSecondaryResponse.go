...
// IoctlSecondaryResponse is the response for SMB_COM_IOCTL_SECONDARY (0x28).
//
...
// a generic "command code not supported" error. A server receiving the request MUST return STATUS_NOT_IMPLEMENTED.
//
// Source: https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-cifs/3a5f8e47-16e6-484d-9346-6c4cbdc22dec
type IoctlSecondaryResponse struct {
	command_interface.Command
}

// NewIoctlSecondaryResponse creates a new IoctlSecondaryResponse structure
//
// Returns:
// - A pointer to the new IoctlSecondaryResponse structure
func NewIoctlSecondaryResponse() *IoctlSecondaryResponse {
	c := &IoctlSecondaryResponse{}
...
// Marshal marshals the IoctlSecondaryResponse structure into a byte array
//
// Returns:
// - A byte array representing the IoctlSecondaryResponse structure
// - An error if the marshaling fails
func (c *IoctlSecondaryResponse) Marshal() ([]byte, error) {
...
func (c *IoctlSecondaryResponse) Unmarshal(rawData []byte) (int, error) {
