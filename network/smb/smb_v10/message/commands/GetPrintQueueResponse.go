...
// GetPrintQueueResponse is the response for SMB_COM_GET_PRINT_QUEUE (0xC3).
//
...
// through to a generic "command code not supported" error. A server receiving the request MUST return STATUS_NOT_IMPLEMENTED.
//
// Source: https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-cifs/8aaa6b27-b144-4cd6-9171-102217b1406d
type GetPrintQueueResponse struct {
	command_interface.Command
}

// NewGetPrintQueueResponse creates a new GetPrintQueueResponse structure
//
// Returns:
// - A pointer to the new GetPrintQueueResponse structure
func NewGetPrintQueueResponse() *GetPrintQueueResponse {
	c := &GetPrintQueueResponse{}
...
// Marshal marshals the GetPrintQueueResponse structure into a byte array
//
// Returns:
// - A byte array representing the GetPrintQueueResponse structure
// - An error if the marshaling fails
func (c *GetPrintQueueResponse) Marshal() ([]byte, error) {
...
func (c *GetPrintQueueResponse) Unmarshal(rawData []byte) (int, error) {
