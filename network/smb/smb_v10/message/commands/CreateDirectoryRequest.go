...
// Source: https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-cifs/06cc0c53-355a-4042-ae24-794aadb412f3
...
//
// Returns:
// - A pointer to the new CreateDirectoryRequest structure
func NewCreateDirectoryRequest() *CreateDirectoryRequest {
	c := &CreateDirectoryRequest{
		// Data
		DirectoryName: types.SMB_STRING{},
	}
...
//
// Returns:
// - A byte array representing the CreateDirectoryRequest structure
