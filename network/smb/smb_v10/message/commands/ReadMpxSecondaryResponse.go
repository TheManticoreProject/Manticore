...
// ReadMpxSecondaryResponse is the response for SMB_COM_READ_MPX_SECONDARY (0x1C).
//
...
type ReadMpxSecondaryResponse struct {
	command_interface.Command
}

// NewReadMpxSecondaryResponse creates a new ReadMpxSecondaryResponse structure
//
// Returns:
// - A pointer to the new ReadMpxSecondaryResponse structure
func NewReadMpxSecondaryResponse() *ReadMpxSecondaryResponse {
	c := &ReadMpxSecondaryResponse{}
...
// Marshal marshals the ReadMpxSecondaryResponse structure into a byte array
//
// Returns:
// - A byte array representing the ReadMpxSecondaryResponse structure
// - An error if the marshaling fails
func (c *ReadMpxSecondaryResponse) Marshal() ([]byte, error) {
...
func (c *ReadMpxSecondaryResponse) Unmarshal(rawData []byte) (int, error) {
