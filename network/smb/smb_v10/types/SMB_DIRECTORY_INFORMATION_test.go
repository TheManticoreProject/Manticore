...
func TestSMB_DIRECTORY_INFORMATION_Marshal(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			expectedOutput: "0516000000000000000000000000000000000000000000000020008001b7d8e7d70183530004000004544553542e5458542020202000",
			expectError:    false,
		},
		{
			...
			expectedOutput: "0516000000000000000000000000000000000000000000000010008001b7d8e7d70183530000000004464f4c44455220202020202000",
			expectError:    false,
		},
		{
			...
			expectedOutput: "051600000102030405060708090a0b0c0d0e0f10010203040010008001b7d8e7d70183530000000004504f44412e4c49524955532000",
			expectError:    false,
		},
		{
			...
			expectedOutput: "0516000000000000000000000000000000000000000000000020008001b7d8e7d7018353000200000441202020202020202020202000",
			expectError:    false,
		},
		{
			...
			expectedOutput: "0516000000000000000000000000000000000000000000000020008001b7d8e7d701835300080000044142434445464748494a4b4c00",
			expectError:    false,
		},
		{
