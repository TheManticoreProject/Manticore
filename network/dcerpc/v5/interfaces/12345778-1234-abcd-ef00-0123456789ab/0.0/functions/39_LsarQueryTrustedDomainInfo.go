...
// ([MS-LSAD] 3.1.4.7.2).
func LsarQueryTrustedDomainInfo(rpc *client.Client, policyHandle structures.LSAPR_HANDLE, trustedDomainSid *dtyp.RPC_SID, infoClass structures.TRUSTED_INFORMATION_CLASS) (*structures.LSAPR_TRUSTED_DOMAIN_INFO, error) {
