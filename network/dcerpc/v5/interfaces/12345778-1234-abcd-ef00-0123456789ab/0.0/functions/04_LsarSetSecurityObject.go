...
func LsarSetSecurityObject(rpc *client.Client, objectHandle structures.LSAPR_HANDLE, securityInformation uint32, securityDescriptor structures.LSAPR_SR_SECURITY_DESCRIPTOR) error {
