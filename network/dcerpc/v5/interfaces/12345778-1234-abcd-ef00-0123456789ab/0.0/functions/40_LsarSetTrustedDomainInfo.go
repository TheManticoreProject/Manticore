...
func LsarSetTrustedDomainInfo(rpc *client.Client, policyHandle structures.LSAPR_HANDLE, trustedDomainSid *dtyp.RPC_SID, infoClass structures.TRUSTED_INFORMATION_CLASS, info structures.LSAPR_TRUSTED_DOMAIN_INFO) error {
