...
func LsarQueryDomainInformationPolicy(rpc *client.Client, policyHandle structures.LSAPR_HANDLE, infoClass structures.POLICY_DOMAIN_INFORMATION_CLASS) (*structures.LSAPR_POLICY_DOMAIN_INFORMATION, error) {
