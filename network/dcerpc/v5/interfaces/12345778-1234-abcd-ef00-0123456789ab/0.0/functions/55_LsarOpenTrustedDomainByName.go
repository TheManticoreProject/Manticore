...
func LsarOpenTrustedDomainByName(rpc *client.Client, policyHandle structures.LSAPR_HANDLE, trustedDomainName string, desiredAccess uint32) (structures.LSAPR_HANDLE, error) {
	...
	if err := rpc.Invoke(req, &resp); err != nil {
		return structures.LSAPR_HANDLE{}, fmt.Errorf("LsarOpenTrustedDomainByName: %w", err)
	}
