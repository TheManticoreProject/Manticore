...
func LsarSetDomainInformationPolicy(rpc *client.Client, policyHandle structures.LSAPR_HANDLE, infoClass structures.POLICY_DOMAIN_INFORMATION_CLASS, info *structures.LSAPR_POLICY_DOMAIN_INFORMATION) error {
	if info != nil {
