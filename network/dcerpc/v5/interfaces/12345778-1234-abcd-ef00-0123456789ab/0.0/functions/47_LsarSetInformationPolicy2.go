...
func LsarSetInformationPolicy2(rpc *client.Client, policyHandle structures.LSAPR_HANDLE, infoClass structures.POLICY_INFORMATION_CLASS, info structures.LSAPR_POLICY_INFORMATION) error {
