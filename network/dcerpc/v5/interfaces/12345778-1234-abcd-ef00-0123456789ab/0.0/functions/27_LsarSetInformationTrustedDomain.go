...
func LsarSetInformationTrustedDomain(rpc *client.Client, trustedDomainHandle structures.LSAPR_HANDLE, infoClass structures.TRUSTED_INFORMATION_CLASS, info structures.LSAPR_TRUSTED_DOMAIN_INFO) error {
