...
func LsarLookupSids2(rpc *client.Client, policyHandle structures.LSAPR_HANDLE, sidEnumBuffer structures.LSAPR_SID_ENUM_BUFFER, lookupLevel structures.LSAP_LOOKUP_LEVEL, lookupOptions uint32, clientRevision uint32) (*structures.LSAPR_REFERENCED_DOMAIN_LIST, structures.LSAPR_TRANSLATED_NAMES_EX, uint32, error) {
