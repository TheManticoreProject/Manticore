...
func NetrServerAliasEnum(rpc *client.Client, serverName string, info structures.SERVER_ALIAS_ENUM_STRUCT, preferedMaximumLength, resumeHandle uint32) (structures.SERVER_ALIAS_ENUM_STRUCT, uint32, uint32, error) {
