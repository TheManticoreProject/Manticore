...
func NetrServerDiskEnum(rpc *client.Client, serverName string, level uint32, diskInfo structures.DISK_ENUM_CONTAINER, preferedMaximumLength, resumeHandle uint32) (structures.DISK_ENUM_CONTAINER, uint32, uint32, error) {
