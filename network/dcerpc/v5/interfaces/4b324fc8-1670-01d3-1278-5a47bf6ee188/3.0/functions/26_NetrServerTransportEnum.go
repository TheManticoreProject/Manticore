...
func NetrServerTransportEnum(rpc *client.Client, serverName string, info structures.SERVER_XPORT_ENUM_STRUCT, preferedMaximumLength, resumeHandle uint32) (structures.SERVER_XPORT_ENUM_STRUCT, uint32, uint32, error) {
