...
func NetrFileEnum(rpc *client.Client, serverName, basePath, userName string, info structures.FILE_ENUM_STRUCT, preferedMaximumLength, resumeHandle uint32) (structures.FILE_ENUM_STRUCT, uint32, uint32, error) {
