...
func NetrSessionEnum(rpc *client.Client, serverName, clientName, userName string, info structures.SESSION_ENUM_STRUCT, preferedMaximumLength, resumeHandle uint32) (structures.SESSION_ENUM_STRUCT, uint32, uint32, error) {
