...
func NetrpSetFileSecurity(rpc *client.Client, serverName, shareName, lpFileName string, securityInformation uint32, securityDescriptor structures.ADT_SECURITY_DESCRIPTOR) error {
