...
func NetrDfsFixLocalVolume(rpc *client.Client, serverName, volumeName string, entryType, serviceType uint32, stgId string, entryUid guid.GUID, entryPrefix string, relationInfo structures.NET_DFS_ENTRY_ID_CONTAINER, createDisposition uint32) error {
