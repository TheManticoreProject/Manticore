...
// ([MS-SRVS] 3.1.4.8).
func NetrShareEnum(rpc *client.Client, serverName string, infoStruct structures.SHARE_ENUM_STRUCT, preferedMaximumLength ndr.DWORD, resumeHandle *ndr.DWORD) (structures.SHARE_ENUM_STRUCT, ndr.DWORD, *ndr.DWORD, error) {
