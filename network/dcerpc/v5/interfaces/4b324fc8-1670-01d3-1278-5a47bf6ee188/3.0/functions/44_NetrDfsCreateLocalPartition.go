...
func NetrDfsCreateLocalPartition(rpc *client.Client, serverName, shareName string, entryUid guid.GUID, entryPrefix, shortName string, relationInfo structures.NET_DFS_ENTRY_ID_CONTAINER, force int32) error {
