...
type s_DSGetComputerSitesResponse struct {
	...
	PpguidSites            []dtyp.GUID `ndr:"unique,size_is=PdwNumberOfSites,varying,length_is=PdwNumberOfSites"`
