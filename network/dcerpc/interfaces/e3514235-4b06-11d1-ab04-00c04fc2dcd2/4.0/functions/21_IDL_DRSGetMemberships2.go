...
type iDL_DRSGetMemberships2Request struct {
	...
	PmsgIn      structures.DRS_MSG_GETMEMBERSHIPS2_REQ
}
...
type iDL_DRSGetMemberships2Response struct {
	...
	PmsgOut       structures.DRS_MSG_GETMEMBERSHIPS2_REPLY
	Status        ndr.DWORD `ndr:"retval"`
}

// IDL_DRSGetMemberships2 calls IDL_DRSGetMemberships2 (opnum 21) ([MS-DRSR] — verify the parameter
// modeling and status handling).
func IDL_DRSGetMemberships2(rpc ndr.Invoker, hDrs structures.DRS_HANDLE, dwInVersion ndr.DWORD, pmsgIn structures.DRS_MSG_GETMEMBERSHIPS2_REQ) (PdwOutVersion ndr.DWORD, PmsgOut structures.DRS_MSG_GETMEMBERSHIPS2_REPLY, err error) {
