...
func IDL_DRSReadNgcKey(rpc ndr.Invoker, hDrs structures.DRS_HANDLE, dwInVersion ndr.DWORD, pmsgIn structures.DRS_MSG_READNGCKEYREQ) (PdwOutVersion ndr.DWORD, PmsgOut structures.DRS_MSG_READNGCKEYREPLY, err error) {
