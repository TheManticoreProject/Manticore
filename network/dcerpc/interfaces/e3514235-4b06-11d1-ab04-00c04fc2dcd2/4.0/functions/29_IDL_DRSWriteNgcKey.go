...
type iDL_DRSWriteNgcKeyRequest struct {
	...
	PmsgIn      structures.DRS_MSG_WRITENGCKEYREQ
}
...
type iDL_DRSWriteNgcKeyResponse struct {
	...
	PmsgOut       structures.DRS_MSG_WRITENGCKEYREPLY
	Status        ndr.DWORD `ndr:"retval"`
}

// IDL_DRSWriteNgcKey calls IDL_DRSWriteNgcKey (opnum 29) ([MS-DRSR] — verify the parameter
// modeling and status handling).
func IDL_DRSWriteNgcKey(rpc ndr.Invoker, hDrs structures.DRS_HANDLE, dwInVersion ndr.DWORD, pmsgIn structures.DRS_MSG_WRITENGCKEYREQ) (PdwOutVersion ndr.DWORD, PmsgOut structures.DRS_MSG_WRITENGCKEYREPLY, err error) {
