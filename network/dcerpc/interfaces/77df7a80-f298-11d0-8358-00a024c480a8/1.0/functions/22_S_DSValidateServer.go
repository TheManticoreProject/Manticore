...
func S_DSValidateServer(rpc ndr.Invoker, pguidEnterpriseId dtyp.GUID, fSetupMode ndr.BOOL, dwContext ndr.DWORD, dwClientBuffMaxSize ndr.DWORD, pClientBuff []uint8, dwClientBuffSize ndr.DWORD) (PphServerAuth msmqds.PPCONTEXT_HANDLE_SERVER_AUTH_TYPE, err error) {
