...
type lsarEnumerateTrustedDomainsExResponse struct {
	EnumerationContext ndr.DWORD
	EnumerationBuffer  mslsad.LSAPR_TRUSTED_ENUM_BUFFER_EX
...
func LsarEnumerateTrustedDomainsEx(rpc ndr.Invoker, policyHandle mslsad.LSAPR_HANDLE, enumerationContext uint32, preferedMaximumLength uint32) (uint32, mslsad.LSAPR_TRUSTED_ENUM_BUFFER_EX, error) {
