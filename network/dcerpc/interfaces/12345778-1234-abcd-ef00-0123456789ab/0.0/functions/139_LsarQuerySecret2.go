...
func LsarQuerySecret2(rpc ndr.Invoker, secretHandle mslsad.LSAPR_HANDLE, encryptedCurrentValue *mslsad.LSAPR_AES_CIPHER_VALUE, currentValueSetTime *dtyp.LARGE_INTEGER, encryptedOldValue *mslsad.LSAPR_AES_CIPHER_VALUE, oldValueSetTime *dtyp.LARGE_INTEGER) (EncryptedCurrentValue *mslsad.LSAPR_AES_CIPHER_VALUE, CurrentValueSetTime *dtyp.LARGE_INTEGER, EncryptedOldValue *mslsad.LSAPR_AES_CIPHER_VALUE, OldValueSetTime *dtyp.LARGE_INTEGER, err error) {
