...
func LsarSetInformationTrustedDomain(rpc ndr.Invoker, trustedDomainHandle mslsad.LSAPR_HANDLE, infoClass mslsad.TRUSTED_INFORMATION_CLASS, info mslsad.LSAPR_TRUSTED_DOMAIN_INFO) error {
