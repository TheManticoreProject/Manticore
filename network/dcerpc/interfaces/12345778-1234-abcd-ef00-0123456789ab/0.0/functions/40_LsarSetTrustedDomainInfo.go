...
func LsarSetTrustedDomainInfo(rpc ndr.Invoker, policyHandle mslsad.LSAPR_HANDLE, trustedDomainSid *dtyp.RPC_SID, infoClass mslsad.TRUSTED_INFORMATION_CLASS, info mslsad.LSAPR_TRUSTED_DOMAIN_INFO) error {
