...
type lsarLookupNamesRequest struct {
	...
	TranslatedSids mslsat.LSAPR_TRANSLATED_SIDS
...
func LsarLookupNames(rpc ndr.Invoker, policyHandle mslsad.LSAPR_HANDLE, names []msdtyp.RPC_UNICODE_STRING, lookupLevel mslsat.LSAP_LOOKUP_LEVEL) (*mslsat.LSAPR_REFERENCED_DOMAIN_LIST, mslsat.LSAPR_TRANSLATED_SIDS, uint32, error) {
