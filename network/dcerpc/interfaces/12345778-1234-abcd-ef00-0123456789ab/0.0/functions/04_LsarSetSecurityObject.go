...
type lsarSetSecurityObjectRequest struct {
	...
	SecurityDescriptor  mslsad.LSAPR_SR_SECURITY_DESCRIPTOR
}
...
func LsarSetSecurityObject(rpc ndr.Invoker, objectHandle mslsad.LSAPR_HANDLE, securityInformation uint32, securityDescriptor mslsad.LSAPR_SR_SECURITY_DESCRIPTOR) error {
