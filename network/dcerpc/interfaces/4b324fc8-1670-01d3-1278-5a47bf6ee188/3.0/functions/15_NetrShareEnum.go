...
// ([MS-SRVS] 3.1.4.8).
func NetrShareEnum(rpc ndr.Invoker, serverName string, infoStruct mssrvs.SHARE_ENUM_STRUCT, preferedMaximumLength ndr.DWORD, resumeHandle *ndr.DWORD) (mssrvs.SHARE_ENUM_STRUCT, ndr.DWORD, *ndr.DWORD, error) {
