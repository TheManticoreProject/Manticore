...
type netrServerDiskEnumRequest struct {
	...
	Level                 ndr.DWORD
	DiskInfoStruct        mssrvs.DISK_ENUM_CONTAINER
...
func NetrServerDiskEnum(rpc ndr.Invoker, serverName string, level uint32, diskInfo mssrvs.DISK_ENUM_CONTAINER, preferedMaximumLength, resumeHandle uint32) (mssrvs.DISK_ENUM_CONTAINER, uint32, uint32, error) {
	...
	if err := rpc.Invoke(req, &resp); err != nil {
		return mssrvs.DISK_ENUM_CONTAINER{}, 0, resumeHandle, fmt.Errorf("NetrServerDiskEnum: %w", err)
	}
