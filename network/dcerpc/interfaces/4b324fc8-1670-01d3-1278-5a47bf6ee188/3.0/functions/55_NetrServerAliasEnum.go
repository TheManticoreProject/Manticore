...
type netrServerAliasEnumRequest struct {
	...
	InfoStruct            mssrvs.SERVER_ALIAS_ENUM_STRUCT
...
func NetrServerAliasEnum(rpc ndr.Invoker, serverName string, info mssrvs.SERVER_ALIAS_ENUM_STRUCT, preferedMaximumLength, resumeHandle uint32) (mssrvs.SERVER_ALIAS_ENUM_STRUCT, uint32, uint32, error) {
	...
	if err := rpc.Invoke(req, &resp); err != nil {
		return mssrvs.SERVER_ALIAS_ENUM_STRUCT{}, 0, resumeHandle, fmt.Errorf("NetrServerAliasEnum: %w", err)
	}
