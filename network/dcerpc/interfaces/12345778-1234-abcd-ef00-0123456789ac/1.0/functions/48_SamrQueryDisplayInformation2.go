...
// Tag.
func SamrQueryDisplayInformation2(rpc ndr.Invoker, domainHandle mssamr.SAMPR_HANDLE, class uint16, index, entryCount, preferredMaximumLength uint32) (uint32, uint32, mssamr.SAMPR_DISPLAY_INFO_BUFFER, error) {
