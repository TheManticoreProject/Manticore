...
type samrConnect5Request struct {
	...
	InVersion      ndr.DWORD
	InRevisionInfo mssamr.SAMPR_REVISION_INFO
}
...
type samrConnect5Response struct {
	...
	OutRevisionInfo mssamr.SAMPR_REVISION_INFO
...
func SamrConnect5(rpc ndr.Invoker, serverName string, desiredAccess uint32) (mssamr.SAMPR_HANDLE, uint32, *mssamr.SAMPR_REVISION_INFO, error) {
	const inVersion = 1
	req := &samrConnect5Request{
		...
		InRevisionInfo: mssamr.SAMPR_REVISION_INFO{
			...
			V1:  mssamr.SAMPR_REVISION_INFO_V1{Revision: 3},
		},
	}
