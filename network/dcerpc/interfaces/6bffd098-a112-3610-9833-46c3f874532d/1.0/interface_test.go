...
// 6bffd098-a112-3610-9833-46c3f874532d, version 1.0 ([MS-DHCPM]).
func TestSyntaxID(t *testing.T) {
	sid := SyntaxID()
	want := guid.GUID{A: 0x6bffd098, B: 0xa112, C: 0x3610, D: 0x9833, E: 0x46c3f874532d}
	if sid.UUID != want {
...
// the wire opnums are the dense range 0..50 the dhcpsrv interface defines.
func TestOpnumNameRoundTrip(t *testing.T) {
	if len(OpnumToName) != 51 {
		t.Fatalf("OpnumToName has %d entries, want 51", len(OpnumToName))
	}
