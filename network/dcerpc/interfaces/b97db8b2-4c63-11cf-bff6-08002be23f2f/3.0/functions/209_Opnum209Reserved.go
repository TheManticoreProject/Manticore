...
func (*opnum209ReservedRequest) Opnum() uint16 { return clusapi.Opnum209Reserved }
...
func Opnum209Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum209Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
