...
func (*opnum198ReservedRequest) Opnum() uint16 { return clusapi.Opnum198Reserved }
...
func Opnum198Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum198Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
