...
func (*opnum189ReservedRequest) Opnum() uint16 { return clusapi.Opnum189Reserved }
...
func Opnum189Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum189Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
