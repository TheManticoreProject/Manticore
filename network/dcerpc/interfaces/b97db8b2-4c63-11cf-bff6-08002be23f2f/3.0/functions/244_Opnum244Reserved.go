...
func (*opnum244ReservedRequest) Opnum() uint16 { return clusapi.Opnum244Reserved }
...
func Opnum244Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum244Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
