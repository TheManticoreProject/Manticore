...
func (*opnum186ReservedRequest) Opnum() uint16 { return clusapi.Opnum186Reserved }
...
func Opnum186Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum186Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
