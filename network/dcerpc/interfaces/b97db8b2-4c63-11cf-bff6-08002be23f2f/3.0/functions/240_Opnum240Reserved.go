...
func (*opnum240ReservedRequest) Opnum() uint16 { return clusapi.Opnum240Reserved }
...
func Opnum240Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum240Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
