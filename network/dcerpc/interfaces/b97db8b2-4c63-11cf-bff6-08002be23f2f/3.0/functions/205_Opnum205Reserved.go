...
func (*opnum205ReservedRequest) Opnum() uint16 { return clusapi.Opnum205Reserved }
...
func Opnum205Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum205Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
