...
func (*opnum226ReservedRequest) Opnum() uint16 { return clusapi.Opnum226Reserved }
...
func Opnum226Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum226Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
