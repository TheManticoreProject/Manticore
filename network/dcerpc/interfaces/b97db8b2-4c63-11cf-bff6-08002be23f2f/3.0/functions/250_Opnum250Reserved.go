...
func (*opnum250ReservedRequest) Opnum() uint16 { return clusapi.Opnum250Reserved }
...
func Opnum250Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum250Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
