...
func (*opnum239ReservedRequest) Opnum() uint16 { return clusapi.Opnum239Reserved }
...
func Opnum239Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum239Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
