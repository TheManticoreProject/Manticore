...
func (*opnum230ReservedRequest) Opnum() uint16 { return clusapi.Opnum230Reserved }
...
func Opnum230Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum230Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
