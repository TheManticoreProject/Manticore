...
func (*opnum231ReservedRequest) Opnum() uint16 { return clusapi.Opnum231Reserved }
...
func Opnum231Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum231Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
