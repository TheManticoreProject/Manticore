...
func (*opnum206ReservedRequest) Opnum() uint16 { return clusapi.Opnum206Reserved }
...
func Opnum206Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum206Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
