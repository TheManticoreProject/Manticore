...
func (*opnum212ReservedRequest) Opnum() uint16 { return clusapi.Opnum212Reserved }
...
func Opnum212Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum212Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
