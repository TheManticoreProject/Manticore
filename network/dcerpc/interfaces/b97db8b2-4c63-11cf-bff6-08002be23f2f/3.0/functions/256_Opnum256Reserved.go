...
func (*opnum256ReservedRequest) Opnum() uint16 { return clusapi.Opnum256Reserved }
...
func Opnum256Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum256Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
