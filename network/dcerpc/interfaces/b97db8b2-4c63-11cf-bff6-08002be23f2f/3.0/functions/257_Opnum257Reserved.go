...
func (*opnum257ReservedRequest) Opnum() uint16 { return clusapi.Opnum257Reserved }
...
func Opnum257Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum257Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
