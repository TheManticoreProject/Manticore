...
func (*opnum235ReservedRequest) Opnum() uint16 { return clusapi.Opnum235Reserved }
...
func Opnum235Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum235Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
