...
func (*opnum211ReservedRequest) Opnum() uint16 { return clusapi.Opnum211Reserved }
...
func Opnum211Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum211Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
