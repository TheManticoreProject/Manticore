...
func (*opnum251ReservedRequest) Opnum() uint16 { return clusapi.Opnum251Reserved }
...
func Opnum251Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum251Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
