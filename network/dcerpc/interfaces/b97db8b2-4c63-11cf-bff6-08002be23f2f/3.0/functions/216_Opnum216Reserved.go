...
func (*opnum216ReservedRequest) Opnum() uint16 { return clusapi.Opnum216Reserved }
...
func Opnum216Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum216Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
