...
func (*opnum213ReservedRequest) Opnum() uint16 { return clusapi.Opnum213Reserved }
...
func Opnum213Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum213Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
