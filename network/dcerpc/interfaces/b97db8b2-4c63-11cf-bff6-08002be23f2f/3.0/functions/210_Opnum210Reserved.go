...
func (*opnum210ReservedRequest) Opnum() uint16 { return clusapi.Opnum210Reserved }
...
func Opnum210Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum210Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
