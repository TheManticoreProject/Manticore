...
func (*opnum228ReservedRequest) Opnum() uint16 { return clusapi.Opnum228Reserved }
...
func Opnum228Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum228Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
