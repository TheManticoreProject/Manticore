...
func (*opnum220ReservedRequest) Opnum() uint16 { return clusapi.Opnum220Reserved }
...
func Opnum220Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum220Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
