...
func (*opnum193ReservedRequest) Opnum() uint16 { return clusapi.Opnum193Reserved }
...
func Opnum193Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum193Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
