...
func (*opnum203ReservedRequest) Opnum() uint16 { return clusapi.Opnum203Reserved }
...
func Opnum203Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum203Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
