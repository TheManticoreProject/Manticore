...
func (*opnum224ReservedRequest) Opnum() uint16 { return clusapi.Opnum224Reserved }
...
func Opnum224Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum224Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
