...
func (*opnum197ReservedRequest) Opnum() uint16 { return clusapi.Opnum197Reserved }
...
func Opnum197Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum197Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
