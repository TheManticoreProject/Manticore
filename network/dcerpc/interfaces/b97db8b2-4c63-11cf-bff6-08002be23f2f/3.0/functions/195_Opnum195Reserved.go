...
func (*opnum195ReservedRequest) Opnum() uint16 { return clusapi.Opnum195Reserved }
...
func Opnum195Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum195Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
