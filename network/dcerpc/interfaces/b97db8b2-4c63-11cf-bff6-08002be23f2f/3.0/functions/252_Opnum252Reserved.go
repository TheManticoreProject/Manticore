...
func (*opnum252ReservedRequest) Opnum() uint16 { return clusapi.Opnum252Reserved }
...
func Opnum252Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum252Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
