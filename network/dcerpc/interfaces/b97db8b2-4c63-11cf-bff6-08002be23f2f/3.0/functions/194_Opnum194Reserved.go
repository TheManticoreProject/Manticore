...
func (*opnum194ReservedRequest) Opnum() uint16 { return clusapi.Opnum194Reserved }
...
func Opnum194Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum194Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
