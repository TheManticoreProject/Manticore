...
func (*opnum236ReservedRequest) Opnum() uint16 { return clusapi.Opnum236Reserved }
...
func Opnum236Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum236Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
