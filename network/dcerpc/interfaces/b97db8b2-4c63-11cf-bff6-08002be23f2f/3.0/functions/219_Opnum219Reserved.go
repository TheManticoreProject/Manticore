...
func (*opnum219ReservedRequest) Opnum() uint16 { return clusapi.Opnum219Reserved }
...
func Opnum219Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum219Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
