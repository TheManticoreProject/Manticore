...
func (*opnum192ReservedRequest) Opnum() uint16 { return clusapi.Opnum192Reserved }
...
func Opnum192Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum192Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
