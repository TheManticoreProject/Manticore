...
func (*opnum187ReservedRequest) Opnum() uint16 { return clusapi.Opnum187Reserved }
...
func Opnum187Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum187Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
