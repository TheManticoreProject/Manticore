...
func (*opnum262ReservedRequest) Opnum() uint16 { return clusapi.Opnum262Reserved }
...
func Opnum262Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum262Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
