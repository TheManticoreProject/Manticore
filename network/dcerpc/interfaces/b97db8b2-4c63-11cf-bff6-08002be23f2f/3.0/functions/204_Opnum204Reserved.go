...
func (*opnum204ReservedRequest) Opnum() uint16 { return clusapi.Opnum204Reserved }
...
func Opnum204Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum204Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
