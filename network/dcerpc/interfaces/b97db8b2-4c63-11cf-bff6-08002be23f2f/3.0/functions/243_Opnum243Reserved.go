...
func (*opnum243ReservedRequest) Opnum() uint16 { return clusapi.Opnum243Reserved }
...
func Opnum243Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum243Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
