...
func (*opnum258ReservedRequest) Opnum() uint16 { return clusapi.Opnum258Reserved }
...
func Opnum258Reserved(rpc ndr.Invoker) (err error) {
	...
	if win32.WIN32_ERROR(resp.Status) != win32.ERROR_SUCCESS {
		err = fmt.Errorf("Opnum258Reserved failed: %s", win32.WIN32_ERROR(resp.Status).String())
	}
	return
}
