...
func RequestUpdates(rpc ndr.Invoker, connectionId msfrs2.FRS_CONNECTION_ID, contentSetId msfrs2.FRS_CONTENT_SET_ID, creditsAvailable ndr.DWORD, hashRequested int32, updateRequestType msfrs2.UPDATE_REQUEST_TYPE, versionVectorDiffCount ndr.DWORD, versionVectorDiff []msfrs2.FRS_VERSION_VECTOR) (FrsUpdate []msfrs2.FRS_UPDATE, UpdateCount ndr.DWORD, UpdateStatus msfrs2.UPDATE_STATUS, GvsnDbGuid dtyp.GUID, GvsnVersion uint64, err error) {
