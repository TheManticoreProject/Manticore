...
func RpcAddPrinterEx(rpc ndr.Invoker, pName *ndr.WSTR, pPrinterContainer structures.PRINTER_CONTAINER, pDevModeContainer structures.DEVMODE_CONTAINER, pSecurityContainer structures.SECURITY_CONTAINER, pClientInfo structures.SPLCLIENT_CONTAINER) (PHandle structures.PRINTER_HANDLE, err error) {
