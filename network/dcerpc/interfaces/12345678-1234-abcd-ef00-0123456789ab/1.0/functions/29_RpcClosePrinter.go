...
type rpcClosePrinterRequest struct {
	PhPrinter structures.PRINTER_HANDLE
}
...
func RpcClosePrinter(rpc ndr.Invoker, phPrinter structures.PRINTER_HANDLE) (PhPrinter structures.PRINTER_HANDLE, err error) {
