...
type rpcPlayGdiScriptOnPrinterICRequest struct {
	HPrinterIC structures.GDI_HANDLE
...
func RpcPlayGdiScriptOnPrinterIC(rpc ndr.Invoker, hPrinterIC structures.GDI_HANDLE, pIn []uint8, cIn ndr.DWORD, cOut ndr.DWORD, ul ndr.DWORD) (POut []uint8, err error) {
