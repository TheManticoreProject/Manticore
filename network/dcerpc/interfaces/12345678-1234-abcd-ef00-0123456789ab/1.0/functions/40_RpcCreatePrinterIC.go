...
type rpcCreatePrinterICResponse struct {
	PHandle structures.GDI_HANDLE
	Status  ndr.DWORD `ndr:"retval"`
}

// RpcCreatePrinterIC calls RpcCreatePrinterIC (opnum 40) ([MS-RPRN] — verify the parameter
// modeling and status handling).
func RpcCreatePrinterIC(rpc ndr.Invoker, hPrinter structures.PRINTER_HANDLE, pDevModeContainer structures.DEVMODE_CONTAINER) (PHandle structures.GDI_HANDLE, err error) {
