...
func RpcEnumPrinterDataEx(rpc ndr.Invoker, hPrinter structures.PRINTER_HANDLE, pKeyName ndr.WSTR, cbEnumValues ndr.DWORD) (PEnumValues []uint8, PcbEnumValues ndr.DWORD, PnEnumValues ndr.DWORD, err error) {
