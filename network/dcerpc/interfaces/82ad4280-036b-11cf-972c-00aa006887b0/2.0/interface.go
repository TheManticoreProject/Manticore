...
// Every method of this interface returns a DWORD Win32 error code ([MS-ERREF] 2.2):
// ERROR_SUCCESS on success, otherwise an implementation-specific nonzero Win32 error
// ([MS-IRP] section 3.1.4). Those codes are not declared here. The whole of [MS-ERREF]
...
// [MS-ERREF] 2.2 has a row for the single value this interface used to declare, under
// the name the declaration carried, so nothing is kept local.
